...
*/
		...
		// jeden komunikat może zawierać kilka flag, powyższe dotyczą również zmiany flagi o
		...
		// jeden komunikat może zawierać kilka flag, powyższy dotyczy również zmiany flagi h
...
*/
		...
		// gdy zmienia inny użytkownik czata:
